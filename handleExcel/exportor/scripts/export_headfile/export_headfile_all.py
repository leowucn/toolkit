...
class GenerateCppFromXls:
	...
	def generate(self, xls_file_name):
		...
		cpp_file_path_name = CPP_DIR + parse_xls_f.staitc_file_name + ".h"

		cpp_file = file(cpp_file_path_name, "wb")
		content_str = '''/*
*
* Copyright 2016
* All rights reserved.
...
namespace '''
		...
		content_str += '\tstruct ' + parse_xls_f.staitc_file_name + '_cfg_t\n\t{\n'
